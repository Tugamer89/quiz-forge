...
* fix: test semantic release pipeline (#192) ([96c90f1](https://github.com/Tugamer89/quiz-forge/commit/96c90f1)), closes [#192](https://github.com/Tugamer89/quiz-forge/issues/192)
* fix(security): [low] suppress PRNG security hotspot in quiz shuffler (#174) ([4e74b5b](https://github.com/Tugamer89/quiz-forge/commit/4e74b5b)), closes [#174](https://github.com/Tugamer89/quiz-forge/issues/174)
* fix(security): resolve potential DOM XSS via markdown a tags (#190) ([ea67591](https://github.com/Tugamer89/quiz-forge/commit/ea67591)), closes [#190](https://github.com/Tugamer89/quiz-forge/issues/190)
* feat(release): add conventional changelog plugin for semantic release ([a4624d8](https://github.com/Tugamer89/quiz-forge/commit/a4624d8))
* test(activity-heatmap): add tests for ActivityHeatmap component (#175) ([ccc2968](https://github.com/Tugamer89/quiz-forge/commit/ccc2968)), closes [#175](https://github.com/Tugamer89/quiz-forge/issues/175)
* test(app): add tests for main App component (#172) ([3878777](https://github.com/Tugamer89/quiz-forge/commit/3878777)), closes [#172](https://github.com/Tugamer89/quiz-forge/issues/172)
* test(features): add unit tests for buildHeatmapData utility (#176) ([96ee2ed](https://github.com/Tugamer89/quiz-forge/commit/96ee2ed)), closes [#176](https://github.com/Tugamer89/quiz-forge/issues/176)
* test(features): add unit tests for DeckOverview component (#182) ([e837880](https://github.com/Tugamer89/quiz-forge/commit/e837880)), closes [#182](https://github.com/Tugamer89/quiz-forge/issues/182)
* test(layout): add tests for Header component (#179) ([cf1783a](https://github.com/Tugamer89/quiz-forge/commit/cf1783a)), closes [#179](https://github.com/Tugamer89/quiz-forge/issues/179)
* test(live-session): add tests for LiveSession component (#177) ([cc16138](https://github.com/Tugamer89/quiz-forge/commit/cc16138)), closes [#177](https://github.com/Tugamer89/quiz-forge/issues/177)
* test(quiz-data): add tests for extractTags utility (#185) ([6fb954c](https://github.com/Tugamer89/quiz-forge/commit/6fb954c)), closes [#185](https://github.com/Tugamer89/quiz-forge/issues/185)
* test(sidebar): add tests for SidebarControls component (#189) ([3c34f71](https://github.com/Tugamer89/quiz-forge/commit/3c34f71)), closes [#189](https://github.com/Tugamer89/quiz-forge/issues/189)
* test(ui-hook): add tests for useAppUI hook missing coverage (#178) ([c32e1ad](https://github.com/Tugamer89/quiz-forge/commit/c32e1ad)), closes [#178](https://github.com/Tugamer89/quiz-forge/issues/178)
* test(use-quiz-session): add unit tests for missing input (#183) ([a07f924](https://github.com/Tugamer89/quiz-forge/commit/a07f924)), closes [#183](https://github.com/Tugamer89/quiz-forge/issues/183)
* test(usequizdata): add unit tests for quiz data hook (#187) ([ed38202](https://github.com/Tugamer89/quiz-forge/commit/ed38202)), closes [#187](https://github.com/Tugamer89/quiz-forge/issues/187)
* perf(deck-overview): optimize tags extraction with flatMap (#188) ([3a0a2a7](https://github.com/Tugamer89/quiz-forge/commit/3a0a2a7)), closes [#188](https://github.com/Tugamer89/quiz-forge/issues/188)
* perf(heatmap): optimize date string generation in activity heatmap (#186) ([9f51dd9](https://github.com/Tugamer89/quiz-forge/commit/9f51dd9)), closes [#186](https://github.com/Tugamer89/quiz-forge/issues/186)
* perf(hooks): remove unnecessary array spread before shuffle (#181) ([f2362c3](https://github.com/Tugamer89/quiz-forge/commit/f2362c3)), closes [#181](https://github.com/Tugamer89/quiz-forge/issues/181)
* perf(useQuizData): avoid redundant iteration for stats computation (#191) ([111ac2b](https://github.com/Tugamer89/quiz-forge/commit/111ac2b)), closes [#191](https://github.com/Tugamer89/quiz-forge/issues/191)
* refactor(app): replace swallowed console.error with Sentry captureException in CodeRenderer (#173) ([f9f42e3](https://github.com/Tugamer89/quiz-forge/commit/f9f42e3)), closes [#173](https://github.com/Tugamer89/quiz-forge/issues/173)
* refactor(hooks): surface localstorage errors to sentry (#180) ([0ff9862](https://github.com/Tugamer89/quiz-forge/commit/0ff9862)), closes [#180](https://github.com/Tugamer89/quiz-forge/issues/180)
* refactor(hooks): track useLocalStorage errors with Sentry (#184) ([acacfff](https://github.com/Tugamer89/quiz-forge/commit/acacfff)), closes [#184](https://github.com/Tugamer89/quiz-forge/issues/184)
* build(deps-dev): bump the dependencies group across 1 directory with 4 updates (#157) ([ac3322f](https://github.com/Tugamer89/quiz-forge/commit/ac3322f)), closes [#157](https://github.com/Tugamer89/quiz-forge/issues/157)
* build(deps): bump actions/setup-node from 6 to 7 in the dependencies group (#145) ([0650c6f](https://github.com/Tugamer89/quiz-forge/commit/0650c6f)), closes [#145](https://github.com/Tugamer89/quiz-forge/issues/145)
* build(deps): bump the dependencies group across 1 directory with 12 updates (#165) ([ce4ccf7](https://github.com/Tugamer89/quiz-forge/commit/ce4ccf7)), closes [#165](https://github.com/Tugamer89/quiz-forge/issues/165)
* build(deps): bump the dependencies group across 1 directory with 13 updates (#150) ([8abf908](https://github.com/Tugamer89/quiz-forge/commit/8abf908)), closes [#150](https://github.com/Tugamer89/quiz-forge/issues/150)
* build(deps): bump the dependencies group across 1 directory with 3 updates (#154) ([26fa44c](https://github.com/Tugamer89/quiz-forge/commit/26fa44c)), closes [#154](https://github.com/Tugamer89/quiz-forge/issues/154)
* build(deps): bump the dependencies group across 1 directory with 5 updates (#171) ([cc36402](https://github.com/Tugamer89/quiz-forge/commit/cc36402)), closes [#171](https://github.com/Tugamer89/quiz-forge/issues/171)
* build(deps): bump the dependencies group across 1 directory with 7 updates (#168) ([882226e](https://github.com/Tugamer89/quiz-forge/commit/882226e)), closes [#168](https://github.com/Tugamer89/quiz-forge/issues/168)
* build(deps): bump the dependencies group with 4 updates (#151) ([89bae00](https://github.com/Tugamer89/quiz-forge/commit/89bae00)), closes [#151](https://github.com/Tugamer89/quiz-forge/issues/151)
* build(deps): bump the dependencies group with 4 updates (#152) ([1db10ad](https://github.com/Tugamer89/quiz-forge/commit/1db10ad)), closes [#152](https://github.com/Tugamer89/quiz-forge/issues/152)

## [1.26.3](https://github.com/Tugamer89/quiz-forge/compare/v1.26.2...v1.26.3) (2026-07-11)
...
## [1.25.2](https://github.com/Tugamer89/quiz-forge/compare/v1.25.1...v1.25.2) (2026-07-08)

## [1.25.1](https://github.com/Tugamer89/quiz-forge/compare/v1.25.0...v1.25.1) (2026-07-08)

## [1.25.0](https://github.com/Tugamer89/quiz-forge/compare/v1.24.0...v1.25.0) (2026-07-08)

## [1.24.0](https://github.com/Tugamer89/quiz-forge/compare/v1.23.0...v1.24.0) (2026-07-07)

## [1.23.0](https://github.com/Tugamer89/quiz-forge/compare/v1.22.1...v1.23.0) (2026-07-07)
...
* Enhance components with accessibility improvements and error handling ([01e3e11](https://github.com/Tugamer89/quiz-forge/commit/01e3e1154ad9a7f102bd34b7afcb7cfb657cded4)), closes [#27](https://github.com/Tugamer89/quiz-forge/issues/27)
...
* **ci:** fixed lighthouse errors ([122293a](https://github.com/Tugamer89/quiz-forge/commit/122293a40e214f28a2e3f423750e10318e854ddc))

# [1.9.0](https://github.com/Tugamer89/quiz-forge/compare/v1.8.1...v1.9.0) (2026-05-06)


### Features

* implement multi-stage Docker build and GHCR publishing ([8d0e4b4](https://github.com/Tugamer89/quiz-forge/commit/8d0e4b4a60d1090d271efcfac23a86c4e5ab969e))

## [1.8.1](https://github.com/Tugamer89/quiz-forge/compare/v1.8.0...v1.8.1) (2026-05-06)


### Bug Fixes

* **monitoring:** set correct Sentry environment based on Vite mode ([e50aa87](https://github.com/Tugamer89/quiz-forge/commit/e50aa8798a89a2a67f19a43212834d02872d27b0))
...
- typo ([1914504](https://github.com/Tugamer89/quiz-forge/commit/1914504fc77629a5a4d5abbcd7b74aae6cbf632a))
...
- resolve syntax highlighting and markdown tag parsing ([48bdd5e](https://github.com/Tugamer89/quiz-forge/commit/48bdd5ef68af224e8f2e6a12cd03cd7a3eecc6fe))
...
- add spaced repetition, advanced markdown, and search filters ([8b9811d](https://github.com/Tugamer89/quiz-forge/commit/8b9811d4237a44818ed581fed14a42d3c75ab290))

## [1.0.1](https://github.com/Tugamer89/quiz-forge/compare/v1.0.0...v1.0.1) (2026-04-27)

### Bug Fixes

- **ui:** correct layout alignment and add missing aria-labels ([e803170](https://github.com/Tugamer89/quiz-forge/commit/e8031704877b271e0cdae0d337e25bd61a36825b))

# [1.0.0](https://github.com/Tugamer89/quiz-forge/compare/bb012f4f1c9a7a93233171bb231f6badcb7870f4...v1.0.0) (2026-04-27)

### Bug Fixes

- add base path for GitHub Pages ([bb012f4](https://github.com/Tugamer89/quiz-forge/commit/bb012f4f1c9a7a93233171bb231f6badcb7870f4))
- deleted emojis from readme ([19fea8f](https://github.com/Tugamer89/quiz-forge/commit/19fea8f59b60d18c6355802d382dc49a59886645))

### Features

- added auto-save and fixed rendering issues ([45b1908](https://github.com/Tugamer89/quiz-forge/commit/45b190848fb1ae165c2a3fd4dba423ededba0bd3))
- implement decks, flashcard UI, import/export and resolve linter warnings ([a5fb149](https://github.com/Tugamer89/quiz-forge/commit/a5fb149f4511dfdfecfaa570b9b92b1d4332fbdd))
- implement PWA installation prompt and localize UI to Italian ([8e52553](https://github.com/Tugamer89/quiz-forge/commit/8e525539340768b38670e46ac1cf0928d292a634))
- **ui:** add professional footer with creator credits and GitHub link ([bbb816c](https://github.com/Tugamer89/quiz-forge/commit/bbb816c5e878ce38b32cb47814bb13e815838d25))
